...
parser.add_argument('--templates_dir', default='/home/anusri/Desktop/emrQA/templates/templates-all.csv', help='Directory containing template files in the given format')

args = parser.parse_args()
csv_reader = list(csv.reader(open(args.templates_dir)))
